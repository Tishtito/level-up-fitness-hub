  ...
  head: () => ({
    meta: [
      ...
      { title: "Level Up Fitness — Transform Your Body. Elevate Your Life." },
      {
        name: "description",
        content:
          "Premium fitness platform with subscriptions, online training, nutrition, physiotherapy, and a curated wellness shop.",
      },
      { property: "og:title", content: "Level Up Fitness" },
      { property: "og:description", content: "Transform Your Body. Elevate Your Life." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Anybody:wdth,wght@80,400;80,600;100,700;120,800&family=Atkinson+Hyperlegible+Next:wght@400;500;600;700&display=swap",
      },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <a
        href="#main-content"
        className="fixed left-4 top-4 z-[60] -translate-y-24 rounded-lg bg-foreground px-4 py-3 text-sm font-semibold text-background transition-transform focus:translate-y-0"
      >
        Skip to content
      </a>
