          ...
          <>
            ...
            <section className="grid gap-6 xl:grid-cols-12">
              <div className="xl:col-span-7 rounded-[1.25rem] bg-[#111827] p-8 text-[#f8fafc] shadow-[var(--shadow-elegant)]">
                <p className="text-sm font-semibold text-[#f8fafc]/75">Physiotherapy services</p>
            ...
            <section className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
              ...
              >
                <p className="text-sm font-semibold text-[#f8fafc]/75">Our therapists</p>
                <h2 className="mt-2 font-display text-3xl font-bold sm:text-4xl">
                ...
                <div className="mt-6 grid gap-4">
                  {services.length > 0
                    ...
                    : fallbackTherapists.map((therapist) => (
                        <article key={therapist.name} className="rounded-[1rem] bg-[#1f2937] p-5">
                          <div className="flex items-start justify-between gap-4">
                            <div>
                              <h3 className="font-display text-xl font-bold">{therapist.name}</h3>
                              <p className="text-sm text-[#f8fafc]/75">{therapist.spec}</p>
                            </div>
                            <span className="inline-flex items-center gap-1 text-sm text-[#f8fafc]/80">
